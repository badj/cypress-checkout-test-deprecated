...
//},
() => {
  it('Log into Automation Practice store to verify valid login credentials to be used for the cart journey test',  () => {
    // Login to Automation Practice App
    cy.logintoAutomationPractice(data.email,data.password)
  })

  it.skip('Automation Practice store - Add to cart journey - The cheapest Printed Summer Dress searched item - Correct selected item added succesfully to the cart - With the correct Size M, Color Green, Quantity 2 and The cart price Totalling $34.80', () => {
